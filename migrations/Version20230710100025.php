 ...
 */
final class Version20230710100025 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE programme_exercice (programme_id INT NOT NULL, exercice_id INT NOT NULL, INDEX IDX_9EA93EA889D40298 (exercice_id), INDEX IDX_9EA93EA862BB7AEE (programme_id), PRIMARY KEY(programme_id, exercice_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
