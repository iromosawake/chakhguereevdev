 ...
 */
final class Version20230731160925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE programme ADD created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD upated DATETIME NOT NULL');
    }
