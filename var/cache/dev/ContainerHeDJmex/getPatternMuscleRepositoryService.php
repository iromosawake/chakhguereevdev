 ...
 */
class getPatternMuscleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PatternMuscleRepository' shared autowired service.
     *
     * @return \App\Repository\PatternMuscleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PatternMuscleRepository.php';

        return $container->privates['App\\Repository\\PatternMuscleRepository'] = new \App\Repository\PatternMuscleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
