...
class getHomeControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.ZYbxp_V'] ?? $container->load('get_ServiceLocator_ZYbxpVService'))->withContext('App\\Controller\\HomeController', $container));
